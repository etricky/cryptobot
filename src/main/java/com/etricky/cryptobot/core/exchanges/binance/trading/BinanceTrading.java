package com.etricky.cryptobot.core.exchanges.binance.trading;
...
@Slf4j
@Component("binanceTradingBean")
public class BinanceTrading extends AbstractExchangeTrading {

	public BinanceTrading(ExchangeThreads exchangeThreads, Commands commands, JsonFiles jsonFiles) {
